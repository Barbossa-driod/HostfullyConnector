...
@Service
public class ComputeReservationsChangeListServiceV2 {

    private static final Logger log = LoggerFactory.getLogger(ComputeReservationsChangeListServiceV2.class);
